...
import static gregtechfoodoption.api.utils.GTFOValues.MODID_GCYS;
...
*/
        ...
        CHEMICAL_RECIPES.recipeBuilder().EUt(64).duration(300)
                ...
                .output(dust,AmmoniumPerchlorate,10)
                .buildAndRegister();
